  ...
  return (
    <section className="border-y border-line bg-ink-800">
      <div className="mx-auto max-w-[1600px] px-5 py-24 md:px-10 md:py-36">
        <Reveal>
          <p className="display max-w-[22ch] font-display text-[10vw] font-extrabold uppercase leading-[0.92] tracking-[-0.045em] text-paper sm:max-w-[24ch] sm:text-[7vw] lg:text-[4.6vw]">
